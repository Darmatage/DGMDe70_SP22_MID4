...
namespace Game.Inventories
{
    ...
    public class ActionStore : MonoBehaviour, ISaveable
    {
        ...
        /// </summary>
        public SO_ActionItem GetAction(int index)
        {
        ...
        public void AddAction(SO_InventoryItem item, int index, int number)
        {
            if (dockedItems.ContainsKey(index))
            {  
        ...
        /// <summary>
        /// Can this item be dropped onto the map?
        /// </summary>
        public bool IsDroppable(int index)
        {
            if (dockedItems.ContainsKey(index))
            {
                return dockedItems[index].item.IsDroppable();
            }
            return false;
        }
        ...
        public int MaxAcceptable(SO_InventoryItem item, int index)
        {
        ...
        void ISaveable.RestoreState(object state)
        {
            ...
            {
                AddAction(SO_InventoryItem.GetFromID(pair.Value.itemID), pair.Key, pair.Value.number);
            }
        }
    }
}